...
> Read the docs to [get started](https://appwarden.io/docs/guides/cloudflare-integration#github-continuous-integration)
...
> [Read the docs](https://appwarden.io/docs/guides/cloudflare-integration#github-continuous-integration) to learn more
