...
> Read the docs to [get started](https://appwarden.io/docs/guides/cloudflare-middleware-integration#github-continuous-integration)
...
| `hostnames`             | Comma-separated list of hostnames to build. If omitted, all hostnames are built. | ❌       | All hostnames |
| `debug`                 | Enable debug mode                                                                | ❌       | `false`       |

> Use the `hostnames` input to deploy only a subset of the domains configured in your Appwarden domain configuration file. Any requested hostnames that are not found in your configuration are skipped with a warning.
    ...
    steps:
      ...
      - name: Build @appwarden/middleware
        ...
        with:
          ...
          # Optional: build only a subset of configured hostnames
